...
public class SaveSketchAsAction extends Action implements IWorkbenchAction {

	private static final String ID = "org.zefer.pixelmeister.actions.SaveSketchAsAction";

	public SaveSketchAsAction() {
		setId(ID);
	}
