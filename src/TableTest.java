 ...
 */
public class TableTest extends ApplicationWindow {
	// The data model
...
class PersonLabelProvider implements ITableLabelProvider, ITableFontProvider, ITableColorProvider {
	/**
	 * Returns the image
	 * 
	 * @param element
    ...
    public Color getBackground(Object element, int columnIndex) {
    	Person person = (Person) element;
          return new Color(Display.getCurrent(), new RGB(125,189,0));
    }
...
class PlayerLabelProvider implements ITableLabelProvider, ITableFontProvider, ITableColorProvider {
    ...
    @Override
    public Color getBackground(Object element, int columnIndex) {
          return new Color(Display.getCurrent(), new RGB(0,50,0));
    }
...
////		Bundle bundle = Platform.getDefault().getBundle();
...
//			e.printStackTrace();
//		}
		File file = new File("file:///c:/windows/fonts/HARLOWSI.TTF");
...
class PlayerContentProvider implements IStructuredContentProvider, ITableFontProvider, ITableColorProvider {
