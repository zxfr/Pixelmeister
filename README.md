...
![Image](i/pixelmeister03.png "icon")
...
![Image](i/pixelmeister04.png "icon")
...
![Image](i/pixelmeister05.png "icon")
...
![Image](i/pixelmeister15.png "icon")
...
![Image](i/pixelmeister16.png "icon")
...
![Image](i/pixelmeister06.png "icon")
...
![Image](i/pixelmeister07.png "icon")
...
![Image](i/pixelmeister08.png "icon")

The image import dialog also includes an option to `Output 0xFFDF instead of 0xFFFF` which helps avoid occasional program loading errors.

### True Type Font Import

One of `Pixelmeister`'s most important features is `TTF` font import, which finally lets you give your microelectronic device a professional-looking interface.
...
Fonts can be imported in "grainy" monochrome mode, which is convenient for `LCD` displays with a limited number of colors. Fonts can also be imported in anti-aliased mode for smooth glyph borders on `TFT` displays.

The animated image below shows how the font size changes when anti-aliasing is turned on/off.

![Image](i/pixelmeister09.gif "icon")
...
![Image](i/pixelmeister10.png "icon")
...
The animated image shows the resulting sizes of the grainy and anti-aliased font:

![Image](i/pixelmeister11.gif "icon")

Once the font has been added to the resources, it can be referenced from the `uText library` and used to display text:

![Image](i/pixelmeister12.png "icon")
...
![Image](i/pixelmeister13.png "icon")
...
![Image](i/pixelmeister18s.jpg "icon")
...
![Image](i/pixelmeister19s.jpg "icon")
